...
/**
 * This class is the static equivalent of SipTestCase. It is intended for use
 * with JUnit 4 or for when the test class must extend something other than
 * SipTestCase.
 * 
...
public class SipAssert
{
     ...
     *            the string identifying the header as specified in RFC-3261.
     */
    public static void assertHeaderPresent(String msg, SipMessage sipMessage,
            String header)
    {
     ...
     *            the string identifying the header as specified in RFC-3261.
     */
    public static void assertHeaderNotPresent(SipMessage sipMessage,
            String header)
    {
     ...
     *            the string identifying the header as specified in RFC-3261.
     */
    public static void assertHeaderNotPresent(String msg,
            SipMessage sipMessage, String header)
    {
        assertNotNull("Null assert object passed in", sipMessage);
     ...
     */
    public static void assertHeaderContains(SipMessage sipMessage,
     ...
     *            matches the value given.
     */
    public static void assertHeaderContains(String msg, SipMessage sipMessage,
            String header, String value)
    {
        assertNotNull("Null assert object passed in", sipMessage);
     ...
     *            matches the value given.
     */
    public static void assertHeaderNotContains(SipMessage sipMessage,
            String header, String value)
    {
     ...
     *            matches the value given.
     */
    public static void assertHeaderNotContains(String msg,
            SipMessage sipMessage, String header, String value)
    {
        assertNotNull("Null assert object passed in", sipMessage);
        ListIterator<Header> l = sipMessage.getHeaders(header);
        while (l.hasNext())
     ...
     */
    public static void assertResponseReceived(int statusCode,
            MessageListener obj)
    {
     ...
     *            The MessageListener object (ie, SipCall, Subscription, etc.).
     */
    public static void assertResponseReceived(int statusCode, String method,
     ...
     *            The MessageListener object (ie, SipCall, Subscription, etc.).
     */
    public static void assertResponseReceived(String msg, int statusCode,
            MessageListener obj)
    {
    ...
    private static boolean responseReceived(int statusCode, String method,
            long sequenceNumber, MessageListener obj)
    {
        ArrayList<SipResponse> responses = obj.getAllReceivedResponses();
     ...
     * 
     */
    public static void assertResponseNotReceived(int statusCode,
            MessageListener obj)
    {
     ...
     *            The MessageListener object (ie, SipCall, Subscription, etc.).
     */
    public static void assertResponseNotReceived(String msg, int statusCode,
            MessageListener obj)
    {
        assertNotNull("Null assert object passed in", obj);
     ...
     * 
     */
    public static void assertResponseNotReceived(int statusCode, String method,
            long sequenceNumber, MessageListener obj)
    {
     ...
     *            The MessageListener object (ie, SipCall, Subscription, etc.).
     */
    public static void assertRequestReceived(String method,
            long sequenceNumber, MessageListener obj)
    {
     ...
     *            The MessageListener object (ie, SipCall, Subscription, etc.).
     */
    public static void assertRequestReceived(String msg, String method,
            MessageListener obj)
    {
        assertNotNull("Null assert object passed in", obj);
    ...
    private static boolean requestReceived(String method, long sequenceNumber,
            MessageListener obj)
    {
        ArrayList<SipRequest> requests = obj.getAllReceivedRequests();
     ...
     * 
     */
    public static void assertRequestNotReceived(String method,
            MessageListener obj)
    {
     ...
     *            The MessageListener object (ie, SipCall, Subscription, etc.).
     */
    public static void assertRequestNotReceived(String msg, String method,
            MessageListener obj)
    {
        assertNotNull("Null assert object passed in", obj);
     ...
     *            given.
     */
    public static void assertBodyContains(String msg, SipMessage sipMessage,
            String value)
    {
        assertNotNull("Null assert object passed in", sipMessage);
     ...
     *            given.
     */
    public static void assertBodyNotContains(String msg, SipMessage sipMessage,
            String value)
    {
        assertNotNull("Null assert object passed in", sipMessage);
     ...
     *            the Subscription in question.
     */
    public static void assertNoSubscriptionErrors(String msg,
