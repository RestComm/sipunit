 ...
 * 
 * Notes are optional. Zero or more notes may be received at the top level of
 * the NOTIFY message, pertaining to the presentity (buddy, watchee).
 * Independently, zero or more notes may be received at the tuple (active
 * device) level, pertaining to that particular device.
 * 
