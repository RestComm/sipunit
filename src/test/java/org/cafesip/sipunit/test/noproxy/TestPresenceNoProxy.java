...
public class TestPresenceNoProxy {
  ...
  public void testBasicSubscription() {
    ...
    try {
      ...
      // Subscription
      assertEquals(s.getTargetUri(), ua.getBuddyInfo(buddy).getTargetUri());
      ...
      assertEquals(response.toString(), s.getLastReceivedResponse() // call
          // anytime
          .getMessage().toString());
      ArrayList<SipResponse> received_responses = s.getAllReceivedResponses(); // call
      // anytime
      assertEquals(1, received_responses.size());
      assertEquals(response.toString(), received_responses.get(0).toString());
      ...
      ArrayList<SipRequest> received_requests = s.getAllReceivedRequests();
      ...
      assertTrue(ub.sendNotify(SubscriptionStateHeader.ACTIVE, null, notify_body, 1800, false));
      ...
      assertEquals(3600, response.getExpires().getExpires());
      assertEquals(response.toString(), s.getLastReceivedResponse().getMessage().toString());
      received_responses = s.getAllReceivedResponses();
      assertEquals(2, received_responses.size());
      assertEquals(response.toString(), received_responses.get(1).toString());
      ...
      assertTrue(ub.sendNotify(SubscriptionStateHeader.ACTIVE, null, notify_body, timeleft, false));
      ...
      assertEquals(SubscriptionStateHeader.TIMEOUT, s.getTerminationReason());
  ...
  public void testEndSubscription() {
    ...
    try {
      ...
      assertEquals(response.toString(), s.getLastReceivedResponse().getMessage().toString());
      ArrayList<SipResponse> received_responses = s.getAllReceivedResponses();
      assertEquals(2, received_responses.size());
      assertEquals(response.toString(), received_responses.get(1).toString());
      ...
      notify_body =
          "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<presence entity=\"sip:becky@cafesip.org\" xmlns=\"urn:ietf:params:xml:ns:pidf\"> <tuple id=\"3\"> <status> <basic>open</basic> </status> </tuple> </presence>";
      assertTrue(ub.sendNotify(SubscriptionStateHeader.TERMINATED, "done", notify_body, 0, false));
  ...
  public void testFetch() {
    ...
    try {
      ...
      // do something with a buddy - sends SUBSCRIBE, gets response
      PresenceSubscriber s = ua.fetchPresenceInfo(buddy, 2000);
      ...
      String notify_body =
          "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<presence entity=\"sip:becky@cafesip.org\" xmlns=\"urn:ietf:params:xml:ns:pidf\"><tuple id=\"1\"><status><basic>closed</basic></status></tuple></presence>";
      assertTrue(ub.sendNotify(SubscriptionStateHeader.TERMINATED, "fetch", notify_body, 0, false));
      ...
      boolean notify_sent =
          ub.sendNotify(SubscriptionStateHeader.TERMINATED, "refetch", notify_body, 0, false);
  ...
  public void testResponseRequestEvent() {
    ...
    try {
      ...
      ArrayList<SipResponse> received_responses = s.getAllReceivedResponses();
      assertEquals(1, received_responses.size());
      assertEquals(resp_event.getClientTransaction(), ((SipResponse) received_responses.get(0))
  ...
  public void testBadNotify() {
    ...
    try {
      ...
      String notify_body =
          "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<presence entity=\"sip:becky@cafesip.org\" xmlns=\"urn:ietf:params:xml:ns:pidf\"><tuple id=\"1\"><status><basic>closed</basic></status></tuple></presence>";
      assertTrue(ub.sendNotify(SubscriptionStateHeader.PENDING, null, notify_body, 3800, false)); // expiry
                                                                                                  // too
                                                                                                  // big
  ...
  public void testErrors() {
    try {
      ...
      assertNotNull(s);
      ResponseEvent resp = s.getCurrentResponse();
      ...
      String notify_body =
          "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<presence entity=\"sip:becky@cafesip.org\" xmlns=\"urn:ietf:params:xml:ns:pidf\"><tuple id=\"1\"><status><basic>closed</basic></status></tuple></presence>";
      assertTrue(ub.sendNotify(SubscriptionStateHeader.ACTIVE, null, notify_body, 1200, false));
      ...
      assertTrue(ub.sendNotify(SubscriptionStateHeader.ACTIVE, null, notify_body, 1000, eventHdr,
  ...
  public void testNotifyPresenceDataDetail() {
    ...
    try {
      ...
      assertTrue(ub.sendNotify(SubscriptionStateHeader.ACTIVE, null, notify_body, 3600, false));
    ...
    try {
      ...
      String notify_body =
          "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<presence entity=\""
              + buddyone
              + "\" xmlns=\"urn:ietf:params:xml:ns:pidf\"><tuple id=\"1\"><status><basic>closed</basic></status></tuple></presence>";
      assertTrue(buddy1.sendNotify(SubscriptionStateHeader.ACTIVE, null, notify_body, 2400, false));
      ...
      notify_body =
          "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<presence entity=\""
              + buddytwo
              + "\" xmlns=\"urn:ietf:params:xml:ns:pidf\"><tuple id=\"1\"><status><basic>closed</basic></status></tuple></presence>";
      assertTrue(buddy2.sendNotify(SubscriptionStateHeader.PENDING, null, notify_body, 2400, false));
      notify_body =
          "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<presence entity=\""
              + buddythree
              + "\" xmlns=\"urn:ietf:params:xml:ns:pidf\"><tuple id=\"3\"><status><basic>open</basic></status></tuple></presence>";
      assertTrue(buddy3.sendNotify(SubscriptionStateHeader.ACTIVE, null, notify_body, 3700, false));
      ...
      notify_body =
          "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<presence entity=\""
              + buddytwo
              + "\" xmlns=\"urn:ietf:params:xml:ns:pidf\"><tuple id=\"3\"><status><basic>open</basic></status></tuple></presence>";
      assertTrue(buddy2.sendNotify(SubscriptionStateHeader.ACTIVE, null, notify_body, 2000, false));
      notify_body =
          "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<presence entity=\""
              + buddythree
      ...
      assertTrue(buddy3.sendNotify(SubscriptionStateHeader.ACTIVE, null, notify_body, 3000, false));
      ...
      assertTrue(buddy1.sendNotify(SubscriptionStateHeader.TERMINATED, "removed", notify_body, 0,
          false));
      ...
      assertTrue(buddy2.sendNotify(SubscriptionStateHeader.TERMINATED, "done", notify_body, 2400,
          false));
      notify_body =
          "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<presence entity=\""
              + buddythree
              + "\" xmlns=\"urn:ietf:params:xml:ns:pidf\"><tuple id=\"7\"><status><basic>open</basic></status></tuple></presence>";
      assertTrue(buddy3.sendNotify(SubscriptionStateHeader.TERMINATED, "all-done", notify_body,
          3700, false));
  ...
  private void setUpTwoBuddies(SipPhone phone, String b1, String b1status, String b2,
    ...
    try {
      ...
      assertTrue(buddy1.sendNotify(SubscriptionStateHeader.ACTIVE, null, notify_body, 3600, false));
      notify_body =
          "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<presence entity=\"" + b2
              + "\" xmlns=\"urn:ietf:params:xml:ns:pidf\"><tuple id=\"2\"><status><basic>"
              + b2status + "</basic></status></tuple></presence>";
      assertTrue(buddy2.sendNotify(SubscriptionStateHeader.ACTIVE, null, notify_body, 3600, false));
